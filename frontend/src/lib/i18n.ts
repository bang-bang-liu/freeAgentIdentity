...
const ZH_MESSAGES = {
  ...
  "accounts.plusTrialEligible": "带Plus试用",
  ...
  "taskLog.cancelTask": "取消任务",
  "taskLog.cancelling": "取消中...",
  "taskLog.cancelFailed": "取消任务失败",
...
const EN_MESSAGES: Record<TranslationKey, string> = {
  ...
  "accounts.autoRegister": "BangBang",
  ...
  "accounts.plusTrialEligible": "Plus trial eligible",
  ...
  "taskLog.cancelTask": "Cancel Task",
  "taskLog.cancelling": "Cancelling...",
  "taskLog.cancelFailed": "Failed to cancel task",
